...
// public:
//
//  ForegroundTaskRunner(std::shared_ptr<facebook::react::MessageQueueThread>
//  queue):queue_(queue){}
//
//  void PostTask(std::unique_ptr<v8::Task> task) override;
//
//  void PostDelayedTask(std::unique_ptr<v8::Task> task, double
//  delay_in_seconds) override { std::abort(); }
//
...
class V8Platform : public v8::Platform {
 ...
 private:
  ...
  // std::map<v8::Isolate*, std::shared_ptr<ForegroundTaskRunner>>
