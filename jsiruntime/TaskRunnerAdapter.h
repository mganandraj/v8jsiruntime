...
class TaskAdapter : public v8runtime::Task {
public:
...
class IdleTaskAdapter : public v8runtime::IdleTask {
public:
...
public:
  TaskRunnerAdapter(std::unique_ptr<v8runtime::TaskRunner>&& taskRunner)
...
private:
  std::unique_ptr<v8runtime::TaskRunner> taskRunner_;
};
